...
const Table = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await fetch('https://y2x1yx2f4l.execute-api.us-east-1.amazonaws.com/deployments', {
        method: 'GET',
        headers: {
    ...
    <div className="p-6">
      <Card>
        <div className="flex justify-between items-center mb-4">
          ...
          <Button type="primary" onClick={() => navigate('/')}>Create New Deployment</Button>
        </div>
        <AntTable 
          columns={columns} 
